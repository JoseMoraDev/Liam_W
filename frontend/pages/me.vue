...
// Cargar datos del usuario desde el endpoint /api/me
onMounted(async () => {
    try {
...
<template>
    <div class="min-h-screen p-6 text-gray-200 bg-gray-900">
        ...
        <div v-if="cargando" class="text-lg text-center">Cargando información del usuario...</div>
                ...
                <table class="min-w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-800/50">
                            ...
                            <td class="p-2">{{ new Date(usuario.created_at).toLocaleString() }}</td>
                        </tr>
                        <tr class="border-b border-gray-700 hover:bg-gray-800/50">
                            <td class="p-2 font-semibold">Última actualización</td>
                            <td class="p-2">{{ new Date(usuario.updated_at).toLocaleString() }}</td>
                        </tr>
                        <tr class="border-b border-gray-700 hover:bg-gray-800/50">
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-800/50">
                            <td class="p-2 font-semibold">Última actualización de ubicación</td>
                            <td class="p-2">
                                {{
                                    usuario.last_location_updated_at
                                        ? new Date(usuario.last_location_updated_at).toLocaleString()
                                        : "—"
                                }}
                            </td>
                        </tr>
